  ...
  <div class="main">
    ...
    <form class="w3-container" method="post">
		<div class="w3-container">
			...
			<input required="true" class="w3-input w3-animate-input" type="text" style="width:75%" id="username" name="username" value="<?=$s_username?>"><br/>
		</div>
		<div class="w3-container">
		...
		<div class="w3-container">
			...
			<input required="true" class="w3-input w3-animate-input" type="text" style="width:75%" id="fullname" name="fullname" value="<?=$s_fullname?>"><br/>
		</div>
		<div class="w3-container">
